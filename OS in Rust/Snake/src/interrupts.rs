...
use crate::snake;
use crate::snake::{init_snake, Snake, Direction};
                ...
                if let Some(key) = keyboard.process_keyevent(key_event) {
                    match key {
                        DecodedKey::Unicode(character) => match character {
                            'w' => unsafe { snake::SNAKE.direction = Direction::Up},
                            'a' => unsafe { snake::SNAKE.direction = snake::Direction::Left},
                            's' => unsafe { snake::SNAKE.direction = snake::Direction::Down },
                            'd' => unsafe { snake::SNAKE.direction = snake::Direction::Right},
                            _ => (),
                        },
